...
use XTP_BUILD\Carbon\Exceptions\InvalidTypeException;
use XTP_BUILD\Carbon\Exceptions\NotLocaleAwareException;
use XTP_BUILD\Carbon\Language;
use XTP_BUILD\Carbon\Translator;
use XTP_BUILD\Carbon\TranslatorStrongTypeInterface;
use Closure;
...
use XTP_BUILD\Symfony\Contracts\Translation\TranslatorInterface as ContractsTranslatorInterface;

// @codeCoverageIgnoreStart
if (interface_exists('XTP_BUILD\\Symfony\\Contracts\\Translation\\TranslatorInterface') &&
    !interface_exists('XTP_BUILD\\Symfony\\Component\\Translation\\TranslatorInterface')
) {
    class_alias(
        'XTP_BUILD\\Symfony\\Contracts\\Translation\\TranslatorInterface',
        'XTP_BUILD\\Symfony\\Component\\Translation\\TranslatorInterface'
    );
}
