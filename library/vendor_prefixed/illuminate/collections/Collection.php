...
use ArrayAccess;
use ArrayIterator;
use XTP_BUILD\Illuminate\Contracts\Support\CanBeEscapedWhenCastToString;
use XTP_BUILD\Illuminate\Support\Traits\EnumeratesValues;
...
class Collection implements ArrayAccess, CanBeEscapedWhenCastToString, Enumerable
{
    ...
    public function getOrPut($key, $value)
    {
        ...
        $this->offsetSet($key, $value = XTP_value($value));
        ...
        usort($items, function ($a, $b) use ($comparisons) {
            foreach ($comparisons as $comparison) {
                ...
                if (! is_string($prop) && is_callable($prop)) {
                    ...
                    $values = [XTP_data_get($a, $prop), XTP_data_get($b, $prop)];
