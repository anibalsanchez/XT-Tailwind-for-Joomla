...
use XTP_BUILD\Illuminate\Support\Enumerable;
use XTP_BUILD\Illuminate\Support\HigherOrderCollectionProxy;
use XTP_BUILD\Illuminate\Support\HigherOrderWhenProxy;
...
trait EnumeratesValues
{
    ...
    public function whereNotBetween($key, $values)
    {
        return $this->filter(function ($item) use ($key, $values) {
            return XTP_data_get($item, $key) < reset($values) || XTP_data_get($item, $key) > end($values);
        });
    }
