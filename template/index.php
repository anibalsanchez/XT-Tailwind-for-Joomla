...
?> font-sans leading-normal bg-white">
  <!-- g-navigation -->
  <header class="static">
    <div class="absolute pin-t pin-l h-32-lite w-full z-10 bg-grey-dark overflow-hidden">
    ...
    <div class="py-8 absolute z-40 w-full">
      <div class="container mx-auto">
        <div class="flex text-3xl">
          <div class="w-5/6">
            <a href="<?php echo $this->baseurl; ?>/" target="_self" title="@Anibal_Sanchez" rel="home" class="font-bold text-white no-underline">@Anibal_Sanchez</a>
          </div>
          <div class="w-1/6">
            <ul class="flex items-center mt-0 ml-6 pl-6 list-reset" dir="ltr">
              <li>
                <a href="https://support.joomgap.com/es/">
                  <img src="https://d1hvvp61iyzquq.cloudfront.net/media/mod_languages/images/es_es.gif" alt="Español" title="Español" class="px-2 py-2" />
                </a>
              </li>
              <li>
                <a href="/en/">
                  <img src="https://d1hvvp61iyzquq.cloudfront.net/media/mod_languages/images/en.gif" alt="English (UK)" title="English (UK)" class="px-2 py-2" />
                </a>
              </li>
            </ul>
          </div>
  ...
  <content class="static">
    <div class="absolute pin-t pin-l h-32-lite w-full z-10 pt-32-lite">
  ...
  <footer class="bg-oldlace text-center">
    <div class="container mx-auto py-8">
      <p>
        © by <a href="https://blog.anibalhsanchez.com" title="Aníbal Sánchez" class="g-powered-by">Aníbal Sánchez</a>. All rights reserved.
      </p>
    </div>
  </footer>
